...
<div class="main">
  <div style="display: flex; justify-content: space-between; align-items: center;">
    <h1 style="margin: 20px 0 10px 10px; color: #2ee9c6;">Welcome to Admin Dashboard</h1>
    <div id="datetime" style="font-weight: bold; font-size: 1.1em; margin: 20px 20px 0 0; color: #2ee9c6;"></div>
  </div>
  <div class="dashboard-cards">
    <div class="dashboard-card">
      <div class="card-title">Earnings</div>
      <div class="card-value" id="earnings">₱42,000</div>
    </div>
    <a href="products.php" class="dashboard-card-link">
      <div class="dashboard-card">
        <div class="card-title">Products</div>
        <div class="card-value" id="products-count">2</div>
      </div>
    </a>
    <a href="orders.php" class="dashboard-card-link">
      <div class="dashboard-card">
        <div class="card-title">Orders</div>
        <div class="card-value" id="orders-count">3</div>
      </div>
    </a>
    <div class="dashboard-card">
      <div class="card-title">Revenue Update</div>
      <div class="card-value" id="revenue-update">₱42,000 This Month</div>
    </div>
    <a href="customers.php" class="dashboard-card-link">
      <div class="dashboard-card">
        <div class="card-title">Customers</div>
        <div class="card-value" id="customers-count">1</div>
      </div>
    </a>
    <a href="messages.php" class="dashboard-card-link">
      <div class="dashboard-card">
        <div class="card-title">Messages</div>
        <div class="card-value" id="messages-count">1</div>
      </div>
    </a>
  </div>
